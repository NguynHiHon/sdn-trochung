...
const certificateLookupNav = {
  title: { vi: "Tra cứu chứng chỉ", en: "Certificate Lookup" },
  dropdown: [],
  fallbackHref: "/certificate/lookup",
};
        ...
        <Container maxWidth="xl">
          ...
          >
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center', gap: 0.5 }}>
              ...
              />
              <DesktopNavDropdown
                item={certificateLookupNav}
                lang={lang}
                hovered={hovered}
                setHovered={setHovered}
                hoverId={certificateLookupNav.title.en}
              />
              <DesktopNavDropdown
                item={aboutNavItem}
                lang={lang}
