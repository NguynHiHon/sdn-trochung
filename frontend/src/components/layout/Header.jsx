...
const navItems = [
  {
    ...
    dropdown: [
      {
        label: { vi: "Tour Dài Ngày", en: "Multi-Day Tours" },
        link: "/#tours",
      },
  ...
  useEffect(() => {
    ...
    getFaqTree()
      .then((res) => {
        ...
        const fromCms = [
          {
            label: { vi: "Tất cả FAQs", en: "All FAQs" },
            link: "/faqs",
          },
  ...
  return (
    <>
        ...
        <Container maxWidth="xl">
          ...
          >
            ...
            >
                ...
                {["EN", "VI"].map((lng) => (
                  <Button
                    ...
                    sx={{
                      ...
                      fontWeight: 700,
                      color:
                        i18n.language === lng.toLowerCase() ? "white" : "#888",
                      bgcolor:
                        i18n.language === lng.toLowerCase()
                          ? "#2b6f56"
                          : "transparent",
                      borderRadius: 0,
                      "&:hover": {
              ...
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    bgcolor: "#1a5a3e",
                    boxShadow: "0 4px 16px rgba(43,111,86,0.35)",
                  },
                }}
              >
                {t("header.bookNow")}
            ...
            <IconButton
              ...
              sx={{ display: { md: "none" }, color: "#1b3a2d" }}
            >
              <MenuIcon />
            </IconButton>
          </Toolbar>
      ...
      >
        ...
        >
          <Typography fontWeight={900} color="#1b3a2d" fontSize="1.2rem">
            OXALIS
          </Typography>
                ...
                <ListItem
                  ...
                  onClick={() =>
                    setMobileExpand((prev) => ({
                      ...prev,
                      [item.title.en]: !prev[item.title.en],
                    }))
                  }
                    ...
                    {subs.map((sub) => (
                      <ListItem
                        ...
                        sx={{
                          pl: 4,
                          borderRadius: 1,
                          "&:hover": { bgcolor: "#edf8f2" },
                        }}
                      >
                        <ListItemText
                          primary={sub.label[lang]}
                          primaryTypographyProps={{
                            fontSize: "0.88rem",
                            color: "#555",
                          }}
        ...
        <Box sx={{ display: "flex", justifyContent: "center", gap: 1, p: 2 }}>
          {["EN", "VI"].map((lng) => (
            <Button
              key={lng}
              variant={
                i18n.language === lng.toLowerCase() ? "contained" : "outlined"
              }
              onClick={() => changeLanguage(lng.toLowerCase())}
              sx={{
                minWidth: 44,
                ...
                borderColor: "#2b6f56",
                color:
                  i18n.language === lng.toLowerCase() ? "white" : "#2b6f56",
              }}
            >
              {lng}
            </Button>
