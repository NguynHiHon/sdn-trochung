...
import CertificateLookupPage from "./pages/Certificate/CertificateLookupPage";
    ...
    <>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/payment/qr/:bookingCode" element={<PaymentQRPage />} />

          <Route element={<MainLayout />}>
            <Route path="/tour/:code" element={<TourDetailPage />} />
            <Route path="/tour/:code/book" element={<TourBookingPage />} />
            <Route path="/certificate/lookup" element={<CertificateLookupPage />} />
